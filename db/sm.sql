...
CREATE TABLE `business` (
  ...
  `remark_id` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '保存数据标记id   无标记为原数据',
  PRIMARY KEY (`id`)
...
CREATE TABLE `evaluate` (
  ...
  `createDate` datetime DEFAULT NULL COMMENT '创建时间',
  `oppenid` int(11) DEFAULT NULL COMMENT '用户凭证',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `goods` (
  ...
  `recommend` int(11) DEFAULT NULL COMMENT '0:好评。1:精品',
  `context` text COLLATE utf8mb4_unicode_ci COMMENT '商品详情',
  `all_type_id` int(11) DEFAULT NULL COMMENT '总分类id',
  `repertory_type` int(11) DEFAULT NULL COMMENT '0:上架,1:下架',
  `remark_id` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '保存数据标记id   无标记为原数据',
  PRIMARY KEY (`id`)
...
CREATE TABLE `goods_type` (
  ...
  `createDate` datetime DEFAULT NULL COMMENT '创建时间',
  `all_type_id` int(11) DEFAULT NULL COMMENT '总分类名',
  `img_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '分类图标',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sys_permission` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='权限表';
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='用户账号表';
