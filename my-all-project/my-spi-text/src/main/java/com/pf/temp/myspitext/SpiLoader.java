...
import com.pf.temp.myspitext.compile.CodeUtil;
import com.pf.temp.myspitext.compile.GroovyCompile;
...
import com.pf.temp.myspitext.selector.api.SelectorWrapper;
...
public class SpiLoader<T> {
    ...
    private SelectorWrapper initSelector(Class<? extends ISelector> clz) {
        ...
        try {
            ...
            Assert.notNull(paramClz,"对象不能为空");
