package com.pf.temp.myspitext.adaptive;


import com.pf.temp.myspitext.SpiLoader;
import com.pf.temp.myspitext.adaptive.code.ICode;
...
//            method.invoke(obj, "ConsoleCode", "protoServer 自适应");
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
    }
    ...
    public void testCodeUtil2() {
        ...
        try {
            ...
            bObject.print("ConsoleCode", "protoServer 自适应");
            System.out.println("--------");
