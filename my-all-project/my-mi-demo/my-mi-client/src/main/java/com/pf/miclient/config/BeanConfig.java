package com.pf.miclient.config;

import com.google.common.util.concurrent.ThreadFactoryBuilder;
import com.pf.miclient.handle.MsgHandleCaller;
import com.pf.miclient.service.impl.MsgCallBackListener;
import com.pf.micommon.constant.Constants;
import com.pf.micommon.data.construct.RingBufferWheel;
...
public class BeanConfig {
    ...
    public OkHttpClient okHttpClient() {
        ...
        builder.connectTimeout(300000, TimeUnit.SECONDS)
